...
\verb#remove_mask(PixelT)# & Strips off the PixelMask wrapper and returns the inner pixel type. \\ \hline
\end{tabular}
...
\verb#copy_mask(im,mask)# & Copies a mask from one image to another. \\ \hline
