...
we are discussing here.  On these systems, you will need to download 
and install GNU {\tt libtool} yourself or use the {\tt libtool} script 
in the root of the VisionWorkbench source distribution directory.}}
\end{center}
