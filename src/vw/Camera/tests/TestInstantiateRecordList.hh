...
//template class  vw::camera::LensDistortionBase<ImplT, ParentCameraT>;
//template class  vw::camera::LinescanModel<PositionFuncT, PoseFuncT>;
//template class  vw::camera::SparseSkylineMatrix<ElemT>;
