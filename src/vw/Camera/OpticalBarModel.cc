...
namespace camera {
    ...
    vw::Vector2i OpticalBarModel::get_image_size    () const { return m_image_size;          }
    vw::Vector2  OpticalBarModel::get_optical_center() const { return m_center_loc_pixels;   }
    double       OpticalBarModel::get_focal_length  () const { return m_focal_length;        }
    double       OpticalBarModel::get_scan_rate     () const { return m_scan_rate_radians;   }
    double       OpticalBarModel::get_speed         () const { return m_speed;               }
    double       OpticalBarModel::get_pixel_size    () const { return m_pixel_size;          }
    double       OpticalBarModel::get_scan_time     () const { return m_scan_time;  }
    bool         OpticalBarModel::get_scan_dir      () const { return m_scan_left_to_right;  }
    double       OpticalBarModel::get_forward_tilt  () const { return m_forward_tilt_radians;}


    void OpticalBarModel::set_camera_center(vw::Vector3 const& position   )     {m_initial_position    = position;}
    void OpticalBarModel::set_camera_pose  (vw::Vector3 const& orientation)     {m_initial_orientation = orientation;}
    void OpticalBarModel::set_camera_pose  (vw::Quaternion<double> const& pose) {set_camera_pose(pose.axis_angle());}

    void OpticalBarModel::set_image_size    (vw::Vector2i image_size    ) { m_image_size           = image_size;
                                                           compute_scan_rate(); }
    void OpticalBarModel::set_optical_center(vw::Vector2  optical_center) { m_center_loc_pixels    = optical_center;
                                                           compute_scan_rate(); }
    void OpticalBarModel::set_focal_length  (double       focal_length  ) { m_focal_length         = focal_length;
                                                           compute_scan_rate(); }
    ...
    void OpticalBarModel::set_speed         (double       speed         ) { m_speed                = speed;          }
    void OpticalBarModel::set_pixel_size    (double       pixel_size    ) { m_pixel_size           = pixel_size;
                                                           compute_scan_rate(); }
    void OpticalBarModel::set_scan_time     (double       scan_time     ) { m_scan_time   = scan_time;     
                                                           compute_scan_rate(); }
    void OpticalBarModel::set_scan_dir      (bool         scan_l_to_r   ) { m_scan_left_to_right   = scan_l_to_r;    }
    void OpticalBarModel::set_forward_tilt  (double       tilt_angle    ) { m_forward_tilt_radians = tilt_angle;     }

    double OpticalBarModel::get_motion_compensation() const           { return m_motion_compensation;    }
    void   OpticalBarModel::set_motion_compensation(double mc_factor) { m_motion_compensation = mc_factor;}

    bool OpticalBarModel::get_have_velocity_vec() const { return m_have_velocity_vec; }
