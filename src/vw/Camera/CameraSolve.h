...
namespace camera {
  ...
  // functions declared in CameraModel class and should work for 
  // any camera. Some cameras may be able to use a faster
  // implementation that solves for y first and then for x separately.
  class CameraGenericLMA : public math::LeastSquaresModelBase<CameraGenericLMA> {
