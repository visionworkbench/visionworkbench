...
template void vw::for_each_pixel < ViewT,FuncT > (const vw::ImageViewBase<ImageT>&, FuncT&);
template void vw::for_each_pixel < ViewT,FuncT > (const vw::ImageViewBase<ImageT>&, const FuncT&);
...
template void vw::for_each_pixel_ < ViewT,FuncT > (const vw::ImageViewBase<ImageT>&, FuncT&);
