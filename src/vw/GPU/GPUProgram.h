...
//########################################################################
  ...
  inline const char* GetStringForShaderLanguageChoiceEnum(ShaderLanguageChoiceEnum choice) {
    switch(choice) {
  ...
  inline void SetShaderLanguageChoice(ShaderLanguageChoiceEnum choice) {
...
//########################################################################
  ...
  inline ShaderCompilationStatusEnum GetShaderCompilationStatus() {
