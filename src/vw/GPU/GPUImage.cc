...
namespace vw { namespace GPU {
    ...
    void GPUImageBase::rasterize_homography() {
...
// DRAW
	...
	Vector2 t_0_0 = h_functor(Vector2(0, 0));
	Vector2 t_1_0 = h_functor(Vector2(width(), 0)); 
	Vector2 t_1_1 = h_functor(Vector2(width(), height()));
	Vector2 t_0_1 = h_functor(Vector2(0, height()));
