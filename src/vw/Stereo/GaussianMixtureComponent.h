  ...
  namespace stereo {
	...
	*/
	...
	if(m != m) { //TODO: handle this better?
	  ...
	  cout << "bbox: " << bbox << endl;
	  cout << "image_r: " << sum_of_pixel_values(crop(image_r, bbox)) << endl;
	  cout << "sum_w: " << sum_of_pixel_values(w) << endl;
	  cout << "sum_w_adj: " << sum_of_pixel_values(w_adj) << endl;
	  cout << m << " -> " << m0 << endl;
	  */
	  m = m0;
	}
	...
	return s;
      ...
      ImageView<PrecisionT> const& errors() const { 
	return err;
      }
	...
	return w;
      ...
      ImageView<PrecisionT> prob() const {  // todo make this more efficient for reading
	return p;	
      }
