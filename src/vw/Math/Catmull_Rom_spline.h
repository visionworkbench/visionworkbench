#ifndef VW_CATMULL_ROM_SPLINE_H
#define VW_CATMULL_ROM_SPLINE_H

// Copied from Boost 1.72 (or so).
// https://gitlab.smartnet.club/boostorg/math/blob/37336e2372e02fa0d2a8ced2313f6e6cbb21337e/include/boost/math/interpolators/catmull_rom.hpp

// Documentation at: https://www.boost.org/doc/libs/master/libs/math/doc/html/math_toolkit/catmull_rom.html

// TODO(oalexan1): When boost is upgraded from the current 1.68, which
// lacks this, need remove this file and use the original boost
// implementation. This will require C++-17 though.
...
Point catmull_rom<Point>::operator()(const typename Point::value_type s) const
{
    ...
    for(size_t j = 0; j < m_pnts[0].size(); ++j)
    {
