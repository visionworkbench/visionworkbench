...
namespace platefile {
  ...
  class AmqpRpcController : public google::protobuf::RpcController {
    bool m_failed;
  ...
  public: 
    ...
    AmqpRpcController() : m_failed(false), m_failed_reason(""), m_timeout_millis(5000) {}
    virtual ~AmqpRpcController() {}
