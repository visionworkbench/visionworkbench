...
namespace vw { 
  ...
  /// Computes the largest integer not greater than each channel of each pixel in an image.
    GENERIC_FRAGMENT_SHADER_FUNCTION_1i0f(trunc, "ImageMath/floor-1i0f") 
  /// Computes the nearest integer to each channel of each pixel in an image, rounding half-way cases away from zero.
  ...
  ///
    GENERIC_FRAGMENT_SHADER_FUNCTION_2i0f(fdim, "ImageMath/fdim-2iII-0f")
  /// 
  ...
  /// 
    GENERIC_FRAGMENT_SHADER_FUNCTION_1i1f_FI(copysign, scalar, "ImageMath/copysign-IF-1i1f")
